...
class AttentionTrainer(simple_trainer.SimpleDistributedTrainer):
    ...
    def compute_reconstruction_loss(
        self, rna_input: torch.Tensor, rna_reconstruction: torch.Tensor
    ) -> torch.Tensor:
    ...
    def compute_loss(
        ...
        rna_projections: torch.Tensor,
    ) -> Dict:
        loss_reconstruction = self.compute_reconstruction_loss(
            rna_input, rna_reconstruction
        )
