...
def main() -> None:
    config = {
        ...
        "dataloader_params": {"batch_size": 32, "num_workers": 16},
        "val_dataloader_params": {"batch_size": 32, "num_workers": 16},
        ...
        "logging_params": {"log_every_n_steps": 10, "log_n_last_models": 1},
